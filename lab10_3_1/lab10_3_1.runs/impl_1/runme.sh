...
HD_PWD='C:/Users/xy424/Documents/VivadoRepository/lab10_3_1/lab10_3_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mealycounter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mealycounter.tcl -notrace
