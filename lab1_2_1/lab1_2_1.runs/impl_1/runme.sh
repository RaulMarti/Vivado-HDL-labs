...
HD_PWD='C:/Users/xy424/Documents/VivadoRepository/lab1_2_1/lab1_2_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dataflow_mux.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dataflow_mux.tcl -notrace
