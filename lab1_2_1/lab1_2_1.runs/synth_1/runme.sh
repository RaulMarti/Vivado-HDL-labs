...
HD_PWD='C:/Users/xy424/Documents/VivadoRepository/lab1_2_1/lab1_2_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dataflow_mux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dataflow_mux.tcl
