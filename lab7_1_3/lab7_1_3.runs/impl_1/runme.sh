...
HD_PWD='C:/Users/xy424/Documents/VivadoRepository/lab7_1_3/lab7_1_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux4x1_behavior.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mux4x1_behavior.tcl -notrace
