...
HD_PWD='C:/Users/xy424/Documents/VivadoRepository/lab7_1_3/lab7_1_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux4x1_behavior.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mux4x1_behavior.tcl
