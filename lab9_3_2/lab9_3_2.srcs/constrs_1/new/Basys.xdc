...
set_property PACKAGE_PIN W14 [get_ports {inits[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {inits[0]}]
set_property PACKAGE_PIN W13 [get_ports {inits[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {inits[1]}]
...
##7 segment display
set_property PACKAGE_PIN W7 [get_ports {y[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {y[7]}]
set_property PACKAGE_PIN W6 [get_ports {y[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {y[6]}]
set_property PACKAGE_PIN U8 [get_ports {y[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {y[5]}]
set_property PACKAGE_PIN V8 [get_ports {y[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {y[4]}]
set_property PACKAGE_PIN U5 [get_ports {y[3]}]					
...
set_property PACKAGE_PIN V7 [get_ports y[0]]							
...
set_property PACKAGE_PIN T18 [get_ports reload]						
