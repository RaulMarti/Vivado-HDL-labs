...
set rc [catch {
  ...
  add_files -quiet C:/Users/xy424/Documents/VivadoRepository/lab9_2_1/lab9_2_1.runs/synth_1/updown_ctr_behavior.dcp
  ...
  link_design -top updown_ctr_behavior -part xc7a35tcpg236-1
...
set rc [catch {
  ...
  phys_opt_design 
  write_checkpoint -force updown_ctr_behavior_physopt.dcp
