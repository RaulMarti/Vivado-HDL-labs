...
HD_PWD='C:/Users/xy424/Documents/VivadoRepository/lab7_1_5/lab7_1_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_behavior_case.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counter_behavior_case.tcl -notrace
