...
HD_PWD='C:/Users/xy424/Documents/VivadoRepository/lab7_1_5/lab7_1_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_behavior_case.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_behavior_case.tcl
