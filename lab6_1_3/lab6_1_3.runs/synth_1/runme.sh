...
HD_PWD='C:/Users/xy424/Documents/VivadoRepository/lab6_1_3/lab6_1_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log delay_line1_behavior.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source delay_line1_behavior.tcl
