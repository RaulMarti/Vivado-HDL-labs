...
HD_PWD='C:/Users/xy424/Documents/VivadoRepository/lab6_1_3/lab6_1_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log delay_line1_behavior.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source delay_line1_behavior.tcl -notrace
